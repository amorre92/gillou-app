...
const Brigands = () => {
    ...
    let note2_m2 = new Vex.Flow.StaveNote({ keys: ["d/5"], duration: "8" }).setStemDirection(-1)
    let note3_m2 = new Vex.Flow.StaveNote({ keys: ["c/5"], duration: "8" }).setStemDirection(-1)
    let note4_m2 = new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "8" }).setStemDirection(-1)
    let note5_m2 = new Vex.Flow.StaveNote({ keys: ["c/5"], duration: "8" }).setStemDirection(-1)
    let note6_m2 = new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "8" }).setStemDirection(-1)
    // beams
    ...
    // measure 3
    // notes
    let note1_m3 = new Vex.Flow.StaveNote({ keys: ["a/4"], duration: "8" })
    let note2_m3 = new Vex.Flow.StaveNote({ keys: ["f/4"], duration: "8r" })
    let note3_m3 = new Vex.Flow.StaveNote({ keys: ["c/5"], duration: "8" }).setStemDirection(-1)
    let note4_m3 = new Vex.Flow.StaveNote({ keys: ["f/5"], duration: "8" }).setStemDirection(-1)
