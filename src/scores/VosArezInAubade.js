...
const VosArezInAubade = () => {

    // measure 1
    // notes
    let note1_m1 = new Vex.Flow.StaveNote({ keys: ["b/4"], duration: "qr" }).addDotToAll()
    let note2_m1 = new Vex.Flow.StaveNote({ keys: ["a/4"], duration: "16" }).setStemDirection(-1)
    ...
    let note5_m2 = new Vex.Flow.StaveNote({ keys: ["d/5"], duration: "16" }).setStemDirection(-1)
    // beams
    let beam1_m2 = new Vex.Flow.Beam([note1_m2, note2_m2])
    let beam2_m2 = new Vex.Flow.Beam([note3_m2, note4_m2, note5_m2])
    // ties
    ...
    let note2_m3 = new Vex.Flow.StaveNote({ keys: ["a/4"], duration: "8" }).setStemDirection(-1)
    let note3_m3 = new Vex.Flow.StaveNote({ keys: ["a/4"], duration: "8" })
