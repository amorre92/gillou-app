...
const MereTantPisMib = () => {
  ...
  let note2_m1 = new Vex.Flow.StaveNote({ keys: ["e/4"], duration: "16" });
  let note3_m1 = new Vex.Flow.StaveNote({ keys: ["f/4"], duration: "16" });
  // beams
  let beam1_m1 = new Vex.Flow.Beam([note2_m1, note3_m1]);

  // measure 2
  // notes
  let note1_m2 = new Vex.Flow.StaveNote({ keys: ["g/4"], duration: "8" });
  let note2_m2 = new Vex.Flow.StaveNote({ keys: ["e/4"], duration: "16" });
  let note3_m2 = new Vex.Flow.StaveNote({ keys: ["f/4"], duration: "16" });
  let note4_m2 = new Vex.Flow.StaveNote({ keys: ["g/4"], duration: "8" });
  let note5_m2 = new Vex.Flow.StaveNote({ keys: ["e/4"], duration: "16" });
  let note6_m2 = new Vex.Flow.StaveNote({ keys: ["f/4"], duration: "16" });
  // beams
