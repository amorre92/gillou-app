...
const DginsDeLesteneMib = () => {
  ...
  let note3_m1 = new Vex.Flow.StaveNote({ keys: ["a/4"], duration: "16" });
  let note4_m1 = new Vex.Flow.StaveNote({ keys: ["g/4"], duration: "8" });
  let note5_m1 = new Vex.Flow.StaveNote({
    keys: ["f/4"],
    duration: "8",
  }).addAccidental(0, new Vex.Flow.Accidental("#"));
  let note6_m1 = new Vex.Flow.StaveNote({ keys: ["g/4"], duration: "8" });
  // beams
