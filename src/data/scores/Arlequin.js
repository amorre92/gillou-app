...
const Arlequin = () => {
    ...
    // measure 2
    // notes
    let note1_m2 = new Vex.Flow.StaveNote({ keys: ["a/5"], duration: "q" }).setStemDirection(-1)
    let note2_m2 = new Vex.Flow.StaveNote({ keys: ["g/5"], duration: "8" }).setStemDirection(-1)
    let note3_m2 = new Vex.Flow.StaveNote({ keys: ["f/5"], duration: "8" }).setStemDirection(-1)
    ...
    let note4_m3 = new Vex.Flow.StaveNote({ keys: ["c/5"], duration: "8" }).setStemDirection(-1)
