...
const ChasseursSib = () => {
  ...
  let note2_m1 = new StaveNote({ keys: ["c/5"], duration: "8" });
  ...
  // measure 3
  // notes
  let note1_m3 = new StaveNote({ keys: ["e/4"], duration: "16" });
  let note2_m3 = new StaveNote({ keys: ["f/4"], duration: "16" });
  let note3_m3 = new StaveNote({ keys: ["g/4"], duration: "16" });
  let note4_m3 = new StaveNote({ keys: ["a/4"], duration: "16" });
